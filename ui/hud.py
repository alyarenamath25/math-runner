...
class HUD:
    ...
    # Setup font & variabel kedip
    def __init__(self):
        self.font = pygame.font.Font(FONT_VCR, 36)
        
        # Variabel efek kedip merah
    ...
    def draw(self, screen, score: int, timer_str: str):
        # 1. Logika penentuan warna Skor (Bergantian Merah dan Putih saat flash_timer aktif)
        if self.flash_timer > 0:
        ...
        # 2. Gambar Skor menggunakan warna yang dinamis
        score_surf = self.font.render(f"SCORE: {score:05d}", True, score_color)
        screen.blit(score_surf, (20, 20))
        
        # 3. Gambar Timer (tetap putih seperti aslinya)
